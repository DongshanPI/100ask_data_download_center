...
.. figure:: http://photos.100ask.net/100ask/products/tools/Software/BtsyncUserGuide/VerysyncUser01.png
	   
	  双击verysync.exe
  
3. 在弹出的对话框里，会提示Windows安全警报，参考下图所示 选中 专用网络， 并点击 **允许访问** 即可。  
  
.. figure:: http://photos.100ask.net/100ask/products/tools/Software/BtsyncUserGuide/VerysyncUser02.png

	选中专用网络并点击允许访问

4. 同时会弹出微力同步首次打开界面，参考下图红框所示， 接受用户协议，并点击开始使用。

.. figure:: http://photos.100ask.net/100ask/products/tools/Software/BtsyncUserGuide/VerysyncUser03.png
...
.. figure:: http://photos.100ask.net/100ask/products/tools/Software/BtsyncUserGuide/VerysyncUser07.png
.. figure:: http://photos.100ask.net/100ask/products/tools/Software/BtsyncUserGuide/VerysyncUser08.png
